...
public class WyRsFragment extends BaseEventBusFragment {
    @Bind(R.id.titlebar)
    ...
    private WyRsListAdapter menuAdapter;
    private List<WyRsInfo> menus;
    private boolean isInitCache = false;

    public static WyRsFragment newInstance() {

        Bundle args = new Bundle();

        WyRsFragment fragment = new WyRsFragment();
    ...
    private void getData() {
        OkGo.<MyResponse>post(MyUrl.baseUrl)
                .params("service", MyUrl.getPersonnelInfo)
                .cacheMode(CacheMode.FIRST_CACHE_THEN_REQUEST)
                .cacheKey(MyUrl.getPersonnelInfo)
            ...
            public void onSuccess(Response<MyResponse> response) {
                ...
                try {
                    menus = ((JSONArray) userData.info).toJavaList(WyRsInfo.class);
                } catch (Exception e) {
