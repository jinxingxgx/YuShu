...
import com.xgx.yushu.bean.TabSelectedEvent;
import com.xgx.yushu.utils.BottomBar;
import com.xgx.yushu.utils.BottomBarTab;
...
public class MainFragment extends SupportFragment {
    ...
    private void initView(View view) {
        ...
        mBottomBar
                ...
                .addItem(new BottomBarTab(_mActivity, R.mipmap.bottom_tab_home, getString(R.string.tab_yushu)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.bottom_bar_circle, getString(R.string.tab_floor)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.bottom_bar_me, getString(R.string.tab_me)));
