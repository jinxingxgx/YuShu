...
//                .params("token", "3215sdf13ad1f65asd4f3ads1f");
    ...
    public T convertResponse(Response response) throws Throwable {
        try {
            ...
            MyResponse myResponse = reader.readObject(MyResponse.class);
            if (myResponse != null && myResponse.data != null) {

                if (myResponse.ret == 200) {
                    if (myResponse.data != null && myResponse.data.getCode() == 1) {
                        return (T) myResponse;
                    } else {
                        throw new IllegalStateException(myResponse.data.msg);
                    }
                } else {
                    throw new IllegalStateException(myResponse.msg);
                }
            } else {
                throw new IllegalStateException(myResponse.msg);
